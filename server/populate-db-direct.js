/**
 * Database population script for CampusSwap using direct database connection
 * 
...
async function populateListings() {
  ...
  for (const listing of allListings) {
    try {
      ...
      console.error(`Error adding listing "${listing.title}":`, err.message);
      errorCount++;
    }
  }
...
populateListings()
  ...
  .finally(() => process.exit(0)); // Ensure the script exits when done
